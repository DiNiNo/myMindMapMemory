...
//set curve
void StoragePoints::curveChange(int index, int indexParentKnot, int startPosX, int startPosY, int endPosX, int endPosY){
    curveStorage[index].indexParentKnot = indexParentKnot;
    curveStorage[index].startPosition_X = startPosX;
    curveStorage[index].startPosition_Y = startPosY;
    curveStorage[index].endPosition_X = endPosX;
    curveStorage[index].endPosition_Y = endPosY;
}
