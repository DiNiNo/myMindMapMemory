...
public:
    ...
    //set curve
    void curveChange(int index, int indexParentKnot, int startPosition_X, int startPosition_Y, int endPosition_X, int endPosition_Y, int c1_X, int c1_Y, int c2_X, int c2_Y);
    ...
    void curveChangeC1(int index, int c1_X, int c1_Y);
    void curveChangeC2(int index, int c2_X, int c2_Y);
    ...
    int curveC1_X(int index);
    int curveC1_Y(int index);
    int curveC2_X(int index);
    int curveC2_Y(int index);
